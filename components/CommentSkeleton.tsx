  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="w-5 h-5 shrink-0 rounded bg-gradient-to-r from-neutral-200 to-neutral-300 dark:from-neutral-700 dark:to-neutral-600 animate-pulse" />
        ...
        {/* Separator */}
        <div className="h-4 w-1 rounded bg-gradient-to-r from-neutral-200 to-neutral-300 dark:from-neutral-700 dark:to-neutral-600 animate-pulse opacity-60" />
      ...
      {level < 2 && (
        <div className="pl-4 ml-2 border-l-2 border-neutral-100 dark:border-neutral-800 space-y-2">
          <div className="flex items-center gap-2">
            ...
            <div className="w-5 h-5 shrink-0 rounded bg-gradient-to-r from-neutral-200 to-neutral-300 dark:from-neutral-700 dark:to-neutral-600 animate-pulse opacity-60" />
            ...
            {/* Nested separator */}
            <div className="h-4 w-1 rounded bg-gradient-to-r from-neutral-200 to-neutral-300 dark:from-neutral-700 dark:to-neutral-600 animate-pulse opacity-40" />
